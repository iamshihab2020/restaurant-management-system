...
export default function SettingsPage() {
  ...
  const handleSaveRestaurant = () => {
    try {
      ...
      toast.success("Restaurant settings have been updated");
    } catch (error) {
  ...
  const handleSaveBusinessModel = () => {
    try {
      ...
      toast.success(`Payment model set to ${paymentModel === "payFirst" ? "Pay First" : "Pay Later"}`);
    } catch (error) {
      console.error("Failed to save business model:", error);
      toast.error("Failed to save business model");
    }
  };
  ...
  const handleSavePayments = () => {
    try {
      ...
      toast.success("Payment method settings have been saved");
    } catch (error) {
  ...
  const handleSavePrinters = () => {
    try {
      ...
      toast.success("Your printer configuration has been updated");
    } catch (error) {
  ...
  const handleTestPrint = () => {
    toast.success("Sending test print to configured printers...");
  };
