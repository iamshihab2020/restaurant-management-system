...
export default function OrdersPage() {
  ...
  const currentUser = mockUsers[2]; // Waiter
  ...
  const handleUpdateStatus = async (orderId: string, newStatus: OrderStatus) => {
    try {
      ...
      toast({
        ...
        description: `Order ${updatedOrder.orderNumber} marked as ${newStatus}`,
      });
    } catch (error) {
      toast({
        title: "Error",
  ...
  const handleDeleteOrder = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `Order ${orderToDelete.orderNumber} has been cancelled`,
        variant: "destructive",
      });
  ...
  const handleToggleSounds = () => {
    ...
    toast({
      ...
      description: newState ? "You will hear notifications for order events" : "Sound notifications are now muted",
    });
  };
                  ...
                  <Button
                    onClick={() => {
                      toast({
                        ...
                        description: `Payment of $${selectedOrder.total.toFixed(2)} collected for ${selectedOrder.orderNumber}`,
                      });
